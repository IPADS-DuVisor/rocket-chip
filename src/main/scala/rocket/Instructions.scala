...
object Instructions {
  ...
  def HUFENCE_VVMA       = BitPat("b1010001??????????000000001110011")
  def HUFENCE_GVMA       = BitPat("b1110001??????????000000001110011")
  ...
  def HULV_B             = BitPat("b111000000000?????100?????1110011")
  def HULV_BU            = BitPat("b111000000001?????100?????1110011")
  def HULV_H             = BitPat("b111001000000?????100?????1110011")
  def HULV_HU            = BitPat("b111001000001?????100?????1110011")
  def HULVX_HU           = BitPat("b111001000011?????100?????1110011")
  def HULV_W             = BitPat("b111010000000?????100?????1110011")
  def HULVX_WU           = BitPat("b111010000011?????100?????1110011")
  def HUSV_B             = BitPat("b1110001??????????100000001110011")
  def HUSV_H             = BitPat("b1110011??????????100000001110011")
  def HUSV_W             = BitPat("b1110101??????????100000001110011")
  def HULV_WU            = BitPat("b111010000001?????100?????1110011")
  def HULV_D             = BitPat("b111011000000?????100?????1110011")
  def HUSV_D             = BitPat("b1110111??????????100000001110011")
  ...
  def RDVTIMECMP         = BitPat("b11100000000100000010?????1110111")
  def WRVTIMECMP         = BitPat("b1110000?????00000001000001110111")
  def RDVTIMECTL         = BitPat("b11110000001000000010?????1110111")
  def WRVTIMECTL         = BitPat("b1111000?????00000001000001110111")
  def RVIPI0             = BitPat("b11001000000100000001?????1110111")
  def CVIPI0             = BitPat("b1100100?????00000010000001110111")
  def SVIPI0             = BitPat("b1100100?????00000011000001110111")
  def RVIPI1             = BitPat("b11010000000100000001?????1110111")
  def CVIPI1             = BitPat("b1101000?????00000010000001110111")
  def SVIPI1             = BitPat("b1101000?????00000011000001110111")
  def RVIPI2             = BitPat("b11011000000100000001?????1110111")
  def CVIPI2             = BitPat("b1101100?????00000010000001110111")
  def SVIPI2             = BitPat("b1101100?????00000011000001110111")
  def RVIPI3             = BitPat("b11101000000100000001?????1110111")
  def CVIPI3             = BitPat("b1110100?????00000010000001110111")
  def SVIPI3             = BitPat("b1110100?????00000011000001110111")
  def RDVCPUID           = BitPat("b11111000000100000010?????1110111")
  def WRVCPUID           = BitPat("b1111100?????00000001000001110111")
...
object CSRs {
  ...
  val huideleg = 0x803
  val huie = 0x804
  val hutimedelta = 0x805
  val hucounteren = 0x806
  val hugeie = 0x807
  val hutval = 0x843
  val huip = 0x844
  val huvip = 0x845
